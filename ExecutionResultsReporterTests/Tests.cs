...
namespace ExecutionResultsReporterTests
{
    public class Tests
    {
        ...
        //    {
        //        new KeyValuePair<string, string>( "ScenarioName", "Room loads and tickets show on entering" ),
        ...
        //    };
        //    var appConfig = CfgRetriver.ReturnConfiguration(@"C:\Users\USER\Documents\GitHub\BingoTestAutomation\Tests\App.config");
